 ...
 * Original file: /npm/codemirror@5.55.0/mode/javascript/javascript.js
 *
  ...
  e.defineMode("javascript", function (t, r) {
    ...
    function v(e, t) {
        ...
        return (
          (t.tokenize =
            ...
            function (e, t) {
              var n,
                a = !1;
              if (c && "@" == e.peek() && e.match(p))
                return (t.tokenize = v), m("jsonld-keyword", "meta");
              for (; null != (n = e.next()) && (n != r || a); )
                a = !a && "\\" == n;
              return a || (t.tokenize = v), m("string", "string");
            })),
          t.tokenize(e, t)
        );
      ...
      if (f.test(n)) {
        ...
        var a = e.current();
        if ("." != t.lastType) {
          if (l.propertyIsEnumerable(a)) {
            var i = l[a];
            return m(i.type, i.style, a);
          }
          if ("async" == a && e.match(/^(\s|\/\*.*?\*\/)*[\[\(\w]/, !1))
            return m("async", "keyword", a);
        }
    ...
    function E(e) {
      ...
      if (((j.marked = "def"), t.context))
        if ("var" == t.lexical.info && t.context && t.context.block) {
          ...
          return void (t.localVars = new T(e, t.localVars));
      r.globalVars &&
        !V(e, t.globalVars) &&
        (t.globalVars = new T(e, t.globalVars));
    }
    function z(e) {
      return (
        "public" == e ||
    ...
    var $ = new T("this", new T("arguments", null));
    function C() {
      (j.state.context = new I(j.state.context, j.state.localVars, !1)),
        (j.state.localVars = $);
    }
    function _() {
      (j.state.context = new I(j.state.context, j.state.localVars, !0)),
      ...
      var r = function () {
        ...
        if ("stat" == r.lexical.type) n = r.lexical.indented;
          ...
          for (var a = r.lexical; a && ")" == a.type && a.align; a = a.prev)
            n = a.indented;
        r.lexical = new h(n, j.stream.column(), e, null, r.lexical, t);
      };
      return (r.lex = !0), r;
    }
    function S() {
    ...
    function N(e, t) {
      return "var" == e
        ...
        ? A()
        : "if" == e
        ? ("else" == j.state.lexical.info &&
            j.state.cc[j.state.cc.length - 1] == S &&
            j.state.cc.pop()(),
          A(q("form"), F, N, S, Ae))
        : "function" == e
        ? A(Ie)
        ...
        ? ((j.marked = "keyword"), A(q("form", "class" == e ? e : t), Oe, S))
        : "variable" == e
        ? u && "declare" == t
          ? ((j.marked = "keyword"), A(N))
          : u &&
          ...
          ? ((j.marked = "keyword"),
            "enum" == t
              ...
              : "type" == t
              ? A($e, P("operator"), le, P(";"))
              : A(q("form"), xe, P("{"), q("}"), oe, S, S))
          : u && "namespace" == t
          ? ((j.marked = "keyword"), A(q("form"), W, N, S))
          : u && "abstract" == t
          ? ((j.marked = "keyword"), A(N))
          : A(q("stat"), Z)
        : "switch" == e
        ? A(q("form"), F, P("{"), q("}", "switch"), _, oe, S, S, O)
        : "case" == e
        ? A(W, P(":"))
        : "default" == e
        ? A(P(":"))
    ...
    function F(e) {
      return "(" != e ? M() : A(q(")"), D, P(")"), S);
    }
    function H(e, t, r) {
      if (j.state.fatArrowAt == j.stream.start) {
        var n = r ? R : Q;
        if ("(" == e) return A(C, q(")"), ae(Ce, ")"), S, P("=>"), n, O);
        if ("variable" == e) return M(C, xe, P("=>"), n, O);
      }
      var a = r ? J : G;
      return x.hasOwnProperty(e)
        ...
        ? A(Ie, a)
        : "class" == e || (u && "interface" == t)
        ? ((j.marked = "keyword"), A(q("form"), _e, S))
        : "keyword c" == e || "async" == e
        ? A(r ? B : W)
        : "(" == e
        ? A(q(")"), D, P(")"), S, a)
    ...
    function L(e) {
      if ("}" == e)
        return (j.marked = "string-2"), (j.state.tokenize = y), A(K);
    }
    function Q(e) {
      return b(j.stream, j.state), M("{" == e ? N : W);
    }
    function R(e) {
      return b(j.stream, j.state), M("{" == e ? N : B);
    }
    function X(e, t) {
      if ("target" == t) return (j.marked = "keyword"), A(G);
    }
    function Y(e, t) {
      if ("target" == t) return (j.marked = "keyword"), A(J);
    }
    function Z(e) {
      return ":" == e ? A(S, N) : M(G, P(";"), S);
    }
    function ee(e) {
      if ("variable" == e) return (j.marked = "property"), A();
    }
    function te(e, t) {
      return "async" == e
        ? ((j.marked = "property"), A(te))
        : "variable" == e || "keyword" == j.style
        ? ((j.marked = "property"),
          "get" == t || "set" == t
            ? A(re)
            : (u &&
                j.state.fatArrowAt == j.stream.start &&
                (r = j.stream.match(/^\s*:\s*/, !1)) &&
                (j.state.fatArrowAt = j.stream.pos + r[0].length),
              A(ne)))
        : "number" == e || "string" == e
        ? ((j.marked = c ? "property" : j.style + " property"), A(ne))
        : "jsonld-keyword" == e
        ? A(ne)
        : u && z(t)
        ? ((j.marked = "keyword"), A(te))
        : "[" == e
        ? A(W, ce, P("]"), ne)
        : "spread" == e
        ? A(B, ne)
    ...
    function re(e) {
      return "variable" != e ? M(ne) : ((j.marked = "property"), A(Ie));
    }
    function ne(e) {
      return ":" == e ? A(B) : "(" == e ? M(Ie) : void 0;
    }
    function ae(e, t, r) {
      function n(a, i) {
        if (r ? r.indexOf(a) > -1 : "," == a) {
          var o = j.state.lexical;
          return (
    ...
    function se(e, t) {
      if (u && (":" == e || "in" == t)) return A(le);
    }
    function ue(e) {
      if (u && ":" == e)
        return j.stream.match(/^\s*\w+\s+is\b/, !1) ? A(W, fe, le) : A(le);
    }
    function fe(e, t) {
      if ("is" == t) return (j.marked = "keyword"), A();
    }
    function le(e, t) {
      return "keyof" == t || "typeof" == t || "infer" == t
        ? ((j.marked = "keyword"), A("typeof" == t ? B : le))
        : "variable" == e || "void" == t
        ? ((j.marked = "type"), A(ve))
        : "|" == t || "&" == t
        ? A(le)
    ...
    function pe(e, t) {
      return "variable" == e || "keyword" == j.style
        ? ((j.marked = "property"), A(pe))
        : "?" == t || "number" == e || "string" == e
        ? A(pe)
        : ":" == e
        ? A(le)
        : "[" == e
        ? A(P("variable"), se, P("]"), pe)
        : "(" == e
        ? M(Te, pe)
        : void 0;
    }
    function me(e, t) {
      return ("variable" == e && j.stream.match(/^\s*[?:]/, !1)) || "?" == t
        ? A(me)
        : ":" == e
        ? A(le)
        : "spread" == e
    ...
    function ve(e, t) {
      return "<" == t
        ...
        ? ((j.marked = "keyword"), A(le))
        : "?" == t
        ? A(le, P(":"), le)
        : void 0;
    }
    function ke(e, t) {
      if ("<" == t) return A(q(">"), ae(le, ">"), S, ve);
    }
    function ye() {
      return M(le, we);
    }
    ...
    function be(e, t) {
      return "enum" == t ? ((j.marked = "keyword"), A(Je)) : M(xe, ce, je, Me);
    }
    function xe(e, t) {
      return u && z(t)
        ? ((j.marked = "keyword"), A(xe))
        : "variable" == e
        ? (E(t), A())
        : "spread" == e
        ? A(xe)
    ...
    function he(e, t) {
      return "variable" != e || j.stream.match(/^\s*:/, !1)
        ? ("variable" == e && (j.marked = "property"),
          "spread" == e
            ? A(xe)
            : "}" == e
            ? M()
    ...
    function Ae(e, t) {
      if ("keyword b" == e && "else" == t) return A(q("form", "else"), N, S);
    }
    function Ve(e, t) {
      return "await" == t ? A(Ve) : "(" == e ? A(q(")"), Ee, S) : void 0;
    }
    function Ee(e) {
      return "var" == e ? A(be, ze) : "variable" == e ? A(ze) : M(ze);
    }
    function ze(e, t) {
      return ")" == e
        ? A()
        ...
        ? A(ze)
        : "in" == t || "of" == t
        ? ((j.marked = "keyword"), A(W, ze))
        : M(W, ze);
    }
    function Ie(e, t) {
      return "*" == t
        ? ((j.marked = "keyword"), A(Ie))
        : "variable" == e
        ? (E(t), A(Ie))
        : "(" == e
        ? A(C, q(")"), ae(Ce, ")"), S, ue, N, O)
        : u && "<" == t
        ? A(q(">"), ae(ye, ">"), S, Ie)
        : void 0;
    }
    ...
    function Oe(e, t) {
      if ("variable" == e) return E(t), A(qe);
    }
    function qe(e, t) {
      return "<" == t
        ? A(q(">"), ae(ye, ">"), S, qe)
        : "extends" == t || "implements" == t || (u && "," == e)
        ? ("implements" == t && (j.marked = "keyword"), A(u ? le : W, qe))
        : "{" == e
        ? A(q("}"), Se, S)
        : void 0;
    }
    function Se(e, t) {
      return "async" == e ||
        ("variable" == e &&
          ("static" == t || "get" == t || "set" == t || (u && z(t))) &&
          j.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
        ? ((j.marked = "keyword"), A(Se))
        : "variable" == e || "keyword" == j.style
        ? ((j.marked = "property"), A(Pe, Se))
        : "number" == e || "string" == e
        ? A(Pe, Se)
        : "[" == e
        ? A(W, ce, P("]"), Pe, Se)
    ...
    function Pe(e, t) {
      ...
      return M(r && "interface" == r.info ? Te : Ie);
    }
    function Ne(e, t) {
      return "*" == t
        ? ((j.marked = "keyword"), A(De, P(";")))
        : "default" == t
        ? ((j.marked = "keyword"), A(W, P(";")))
        : "{" == e
        ? A(ae(Ue, "}"), De, P(";"))
        : M(N);
    }
    function Ue(e, t) {
      return "as" == t
        ? ((j.marked = "keyword"), A(P("variable")))
        : "variable" == e
        ? M(B, Ue)
        : void 0;
    }
    function We(e) {
      return "string" == e ? A() : "(" == e ? M(W) : M(Be, Fe, De);
    }
    function Be(e, t) {
      return "{" == e
        ? ie(Be, "}")
        : ("variable" == e && E(t), "*" == t && (j.marked = "keyword"), A(He));
    }
    function Fe(e) {
      if ("," == e) return A(Be, Fe);
    }
    function He(e, t) {
      if ("as" == t) return (j.marked = "keyword"), A(Be);
    }
    function De(e, t) {
      if ("from" == t) return (j.marked = "keyword"), A(W);
    }
    function Ge(e) {
      return "]" == e ? A() : M(ae(B, "]"));
    }
    function Je() {
      return M(q("form"), xe, P("{"), q("}"), ae(Ke, "}"), S, S);
    }
    function Ke() {
      return M(xe, je);
    }
      ...
      (S.lex = !0),
      {
        startState: function (e) {
          var t = {
            ...
            context: r.localVars && new I(null, null, !1),
            indented: e || 0,
          };
          return (
            r.globalVars &&
          ...
          return "vardef" == l
            ...
            ? s.indented +
              ((function (e, t) {
                ...
                ? o || i
                : 0)
            : "switch" != s.info || p || 0 == r.doubleIndentSwitch
            ? s.align
              ? s.column + (p ? 0 : 1)
              : s.indented + (p ? 0 : i)
...
//# sourceMappingURL=/sm/fee91478e687912afef9bca1285e0cbb8f34925995541bfbee263de9b0bdaa68.map
